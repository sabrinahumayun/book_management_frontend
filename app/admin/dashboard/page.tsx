        ...
        <Container maxWidth="xl" sx={{ py: 2, px: { xs: 2, sm: 3 } }}>
          ...
          <Box sx={{ display: 'flex', gap: 2, mb: 3, flexWrap: 'wrap' }}>
            <Box sx={{ flex: '1 1 300px', minWidth: 300 }}>
              <Card sx={{ height: '100%', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
                <CardContent sx={{ p: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Chip label="Quick" color="primary" size="small" />
                    </Box>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Chip label="Moderate" color="success" size="small" />
                    </Box>
                  </Box>
                </CardContent>
              </Card>
              ...
              <Card sx={{ height: '100%', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06)' }}>
                <CardContent sx={{ p: 2 }}>
                  ...
                  <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                    ...
                    <Alert severity="info" icon={<MessageSquare />} sx={{ py: 0.5 }}>
                      <Typography variant="body2" fontWeight="600">
                        New Reviews
                      </Typography>
                      <Typography variant="caption">
                        {totalFeedback} reviews pending approval
                      </Typography>
                    </Alert>
                  </Box>
                </CardContent>
